...
| [Microsoft SQL Server 2012 Parallel Data Warehouse (Analytics Platform System)](/lifecycle/products/microsoft-sql-server-2012-parallel-data-warehouse-analytics-platform-system?branch=live)<br>[Windows Server 2012, 1. vuoden laajennettu tietosuojapäivitys](/lifecycle/products/windows-server-2012?branch=live)<br>[Windows Server 2012 R2, 1. vuoden laajennettu tietosuojapäivitys](/lifecycle/products/windows-server-2012-r2?branch=live)<br> | 8. lokakuuta 2024 |
| [Windows Embedded POSReady 7, 3. vuoden laajennettu tietosuojapäivitys*](/lifecycle/products/windows-embedded-posready-7?branch=live)<br> | maanantai 14. lokakuu 2024 |
